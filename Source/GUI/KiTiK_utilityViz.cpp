...
//=======================================FFTData===================================
void kitik::FFTData::pushNextSampleIntoFifo(juce::AudioBuffer<float> buffer)
{
...
//=======================================FFT=======================================
kitik::FFT::FFT(FFTData& d)
    : data(d) {}

kitik::FFT::~FFT(){}

void kitik::FFT::paint(juce::Graphics& g)
{
...
void kitik::FFT::resized() {}

void kitik::FFT::drawNextFrame(FFTData& data)
{
...
kitik::OscilloscopeComp::OscilloscopeComp(SimpleSynthAudioProcessor& p)
    : audioProcessor(p) {}

kitik::OscilloscopeComp::~OscilloscopeComp() {}

void kitik::OscilloscopeComp::paint(juce::Graphics& g)
{
    auto bounds = getLocalBounds();
...
void kitik::OscilloscopeComp::resized() {}
